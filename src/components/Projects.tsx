  ...
  const dummyProjects: Project[] = [
    {
      ...
      project_url: "https://example.com/demo1",
    ...
    },
    {
      ...
      image_url: "https://via.placeholder.com/600x350?text=Project+2",
    ...
    },
    {
      ...
      description: "An AI assistant powered by OpenAI APIs and React Query.",
      image_url: "https://via.placeholder.com/600x350?text=Project+3",
      technologies: ["React", "OpenAI", "React Query"],
      project_url: "https://example.com/demo3",
        ...
        {isLoading ? (
          ...
          <div className="text-center py-12">
            <p className="text-muted-foreground text-lg">
              No projects to display yet. Add some from your backend!
            </p>
          </div>
        )}
      </div>
